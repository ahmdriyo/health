...
export default function SvgMenu({width,height}){
  const login = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const SvgMenu = () => <SvgXml xml={login} width={width} height={height}/>
    return(<SvgMenu/>)
}